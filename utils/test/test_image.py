...
@pytest.mark.parametrize('version_file,expected_result',
                         [(VERSION_FILE_1, VERSION_INFO_1),
                          (VERSION_FILE_1HF, VERSION_INFO_1HF)])
...
@pytest.mark.parametrize('edition, _short_edition', [
    (None, None),
    ('Final', 'Final'),
    ('Hotfix HF1', 'HF1'),
    ('Hotfix DUMMY', 'HF'),
